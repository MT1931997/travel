...
<?php $__env->startSection('title', __('messages.fingerprint')); ?>

<?php $__env->startSection('content'); ?>
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><?php echo e(__('messages.fingerprint')); ?></h3>
    </div>
    <div class="card-body">

        <button class="button btn btn-success" id="getLocation"><?php echo e(__('messages.fingerprint')); ?></button>
        <p id="locationInfo"></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.1.6\htdocs\travel\resources\views/admin/employee/fingerprint.blade.php ENDPATH**/ ?>