    ...
    <ul class="navbar-nav ms-auto">
        <li class="nav-item dropdown">
            <a class="user-dropdown" data-toggle="dropdown" href="#">
                <img src="<?php echo e(url('assets/admin/dist/img/avatar.png')); ?>" class="user-image" alt="User Avatar">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="<?php echo e(route('admin.login.edit', auth()->user()->id)); ?>" class="dropdown-item">
...
<?php /**PATH D:\xampp8.1.6\htdocs\travel\resources\views/admin/includes/navbar.blade.php ENDPATH**/ ?>