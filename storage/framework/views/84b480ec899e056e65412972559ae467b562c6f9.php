...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        <!-- Navbar -->
        <?php echo $__env->make('superAdmin.includes.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Main Sidebar Container -->
        <?php echo $__env->make('superAdmin.includes.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Content Wrapper. Contains page content -->
        <?php echo $__env->make('superAdmin.includes.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Footer -->
        <?php echo $__env->make('superAdmin.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!-- ./wrapper -->
...
<?php /**PATH D:\xampp8.1.6\htdocs\travel\resources\views/layouts/superAdmin.blade.php ENDPATH**/ ?>