...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        searchInput.addEventListener('input', function () {
            ...
            if (query.length > 0) {
                fetch('<?php echo e(route('search')); ?>?query=' + query + '&model=<?php echo e(addslashes($model_search_select2)); ?>')
...
<?php /**PATH D:\xampp8.1.6\htdocs\travel\resources\views/inputs/search_select2.blade.php ENDPATH**/ ?>