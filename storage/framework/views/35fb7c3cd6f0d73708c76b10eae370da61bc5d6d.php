...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo e(url('assets/admin/fonts/ionicons/2.0.1/css/ionicons.min.css')); ?>">
  <!-- icheck bootstrap -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">تسجيل الدخول للوحة السوبر ادمن </p>
      <form action="<?php echo e(route('superAdmin.login')); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp8.1.6\htdocs\travel\resources\views/superAdmin/auth/login.blade.php ENDPATH**/ ?>