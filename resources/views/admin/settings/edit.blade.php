                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="company_no" id="company_no" class="form-control" value="{{ old('company_no',$data['company_no']) }}">
                            @error('company_no')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="lat" id="lat" class="form-control" value="{{ old('lat',$data['lat']) }}">
                            @error('lat')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="lng" id="lng" class="form-control" value="{{ old('lng',$data['lng']) }}">
                            @error('lng')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="whats_no" id="whats_no" class="form-control" value="{{ old('whats_no',$data['whats_no']) }}">
                            @error('whats_no')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
