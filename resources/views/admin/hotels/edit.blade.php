...
@section('title')
    {{ __('messages.Edit') }} {{ __('messages.hotels') }}
@endsection



@section('contentheaderlink')
    <a href="{{ route('hotels.index') }}"> {{ __('messages.hotels') }} </a>
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title card_title_center"> {{ __('messages.Edit') }} {{ __('messages.hotels') }} </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
