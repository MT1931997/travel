...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            @can('setting-table')
                <form action="{{ route('superAdmin.login.update', $data['id']) }}" method="post">
                    <div class="row">
                        @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="username" id="name" class="form-control"
                        ...
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                ...
                                <a href="{{ route('superAdmin.dashboard') }}" class="btn btn-sm btn-danger">cancel</a>
