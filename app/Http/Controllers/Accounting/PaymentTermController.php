...
class PaymentTermController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "Accounting-paymentTerm-table";
        $this->create_var = "Accounting-paymentTerm-add";
        $this->edit_var = "Accounting-paymentTerm-edit";
        $this->delete_var = "Accounting-paymentTerm-delete";
        ...
        [
            ...
            __('messages.percent'),
            __('messages.payment_terms_types'),
            __('messages.note'),
        ];
        $this->columns_table_name = ['number', 'name', 'foreign_name','number_of_days', 'percent', 'payment_terms_types','note'];
        $this->inputTypes = ['text', 'text','text','text', 'text','options','text_area'];
        $this->required = ['required', 'required',null,'required',null,'required',null];
        $this->options = [
            ['1' => 'balance', '2' => 'نسبة','3' => 'قيمة ثابتة'],
        ];

        $this->routeName = 'paymentTerms'; // Change to your route name
        $this->modelName = PaymentTerm::class; // Change to your model name
