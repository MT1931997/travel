...
class CheckPortfolioController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "ReceivePay-checkPortfolio-table";
        $this->create_var = "ReceivePay-checkPortfolio-add";
        $this->edit_var = "ReceivePay-checkPortfolio-edit";
        $this->delete_var = "ReceivePay-checkPortfolio-delete";
        ...
        [
            ...
            __('messages.branch'),
            __('messages.bank_account_id'),
            __('messages.Cheques_payment_accuont_id'),
            __('messages.Cheques_under_collection_account_id'),
            __('messages.note'),
        ];
        $this->columns_table_name = [ 'number', 'name', 'foreign_name','branch','bank_account_id','Cheques_payment_accuont_id','Cheques_under_collection_account_id','note'];
        $this->inputTypes = ['text', 'text','text','select_another_table','search_select','search_select','search_select','text_area'];
        $this->required = ['required', 'required',null,'required', 'required','required', 'required',null];
        $this->options = ['male','female'];
        $this->routeName = 'checkPortfolios'; // Change to your route name
        $this->modelName = CheckPortfolio::class; // Change to your model name
