...
class AccountController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "Accounting-account-table";
        $this->create_var = "Accounting-account-add";
        $this->edit_var = "Accounting-account-edit";
        $this->delete_var = "Accounting-account-delete";
        ...
        [
            ...
            __('messages.balance_limit'),
            __('messages.is_cost_center_required'),
            __('messages.is_account_bank'),
            __('messages.is_account_tax'),
        ...
        $this->required = ['required', 'required',null,null,null,null,null,'required','required'];
        $this->options = [
            ['1' => 'Active', '2' => 'Inactive'],
            ['1' => 'Active', '2' => 'Inactive'],
            ['1' => 'Active', '2' => 'Inactive'],
        ...
        $this->routeName = 'accounts'; // Change to your route name
        $this->modelName = Account::class; // Change to your model name
        $this->model_name_for_another_table_select = Branch::class; // Change to  model name
        $this->currentApplicationName = "Accounting";
        $this->var_releation_radio_tree = 'main_account_id'; // هون بنحط اسم الكولومن الموجود في الداتابيس تاع هاد الموديل
        ...
        $this->another_table_for_radio = MainAccount::class; // keep it null . if there is another model change it
