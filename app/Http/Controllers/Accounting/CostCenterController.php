...
class CostCenterController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "Accounting-costCenter-table";
        $this->create_var = "Accounting-costCenter-add";
        $this->edit_var = "Accounting-costCenter-edit";
        $this->delete_var = "Accounting-costCenter-delete";
        ...
        $this->routeName = 'costCenters'; // Change to your route name
        $this->modelName = CostCenter::class; // Change to your model name
