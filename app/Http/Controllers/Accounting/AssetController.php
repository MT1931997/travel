...
class AssetController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "Accounting-asset-table";
        $this->create_var = "Accounting-asset-add";
        $this->edit_var = "Accounting-asset-edit";
        $this->delete_var = "Accounting-asset-delete";
        ...
        [
            ...
            __('messages.start_calculation_date'),
            __('messages.quantity'),
            __('messages.price_without_tax'),
            __('messages.annual_consumption_ratio'),
            __('messages.total_depreciation_hours'),
            __('messages.currency_rate'),
            __('messages.date_of_relase'),
            __('messages.tax_value'),
            __('messages.stamps'),
            __('messages.accumolated'),
            __('messages.asset_minimum'),
            __('messages.currency_id'),
            __('messages.branch'),
            __('messages.asset_account_id'),
            __('messages.accumulated_depreciation_account_id'),
            __('messages.expensed_depreciation_account_id'),
            __('messages.partner_id'),
            __('messages.note'),
        ];
        $this->columns_table_name = [
            ...
            'quantity',
            'price_without_tax',
            'annual_consumption_ratio',
            'total_depreciation_hours',
            'currency_rate',
            'date_of_relase',
            'tax_value',
            'stamps',
            ...
            'expensed_depreciation_account_id',
            'partner_id',
            'note',
        ];
        $this->inputTypes = [
            ...
            'text', 'date','text',
            'text', 'text','options',
            'select_another_table_two', 'select_another_table','search_select','search_select','search_select','search_select2','text_area'
        ];
        $this->required = [
        ...
        $this->routeName = 'assets'; // Change to your route name
        $this->modelName = Asset::class; // Change to your model name
        $this->model_name_for_another_table_select = Branch::class; // Change to  model name
        $this->model_name_for_another_table_select2 = Currency::class; // Change to  model name
        ...
        $this->model_search_select = Account::class; // model::class if there is model
        $this->model_search_select2 = Employee::class; // model::class if there is model
