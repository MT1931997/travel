...
class CreditCardController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "Accounting-creditCard-table";
        $this->create_var = "Accounting-creditCard-add";
        $this->edit_var = "Accounting-creditCard-edit";
        $this->delete_var = "Accounting-creditCard-delete";
        ...
        [
            ...
            __('messages.percent'),
            __('messages.value'),
            __('messages.expense_account_id'),
            __('messages.bank_account_id'),
            __('messages.branch'),
            __('messages.photo'),
        ];
        $this->columns_table_name = ['number', 'name', 'foreign_name','percent','value','expense_account_id','bank_account_id','branch_id','photo',];
        $this->inputTypes = ['text', 'text','text','text','text','search_select','search_select','select_another_table','photo'];
        $this->required = ['required', 'required',null,null,null,'required', 'required','required',null];
        $this->options = ['male','female'];
        $this->routeName = 'creditCards'; // Change to your route name
        $this->modelName = CreditCard::class; // Change to your model name
