...
class SuplierCategoryController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "Accounting-suplierCategory-table";
        $this->create_var = "Accounting-suplierCategory-add";
        $this->edit_var = "Accounting-suplierCategory-edit";
        $this->delete_var = "Accounting-suplierCategory-delete";
        ...
        $this->columns_table_name = ['number', 'name', 'foreign_name','branch_id'];
        $this->inputTypes = ['text', 'text','text','select_another_table'];
        $this->required = ['required', 'required',null,'required'];
        $this->options = ['male','female'];
        $this->routeName = 'suplierCategories'; // Change to your route name
        $this->modelName = SuplierCategory::class; // Change to your model name
