...
class CurrencyController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "Settings-currency-table";
        $this->create_var = "Settings-currency-add";
        $this->edit_var = "Settings-currency-edit";
        $this->delete_var = "Settings-currency-delete";

        $this->columnsIndex = ['id','Number', 'Name','Currency_rate'];
        $this->columns_view =
        [
            __('messages.Number'),
            __('messages.Name'),
        ...
        $this->columns_table_name = ['number', 'name', 'foreign_name','symbol','currency_rate'];
        $this->inputTypes = ['text', 'text','text','text','text',];
        $this->required = ['required', 'required',null,null,'required'];
        $this->options = ['male','female'];
        $this->routeName = 'currencies'; // Change to your route name
        $this->modelName = Currency::class; // Change to your model name
