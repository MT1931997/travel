...
class InvoiceTypeController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "Accounting-invoiceType-table";
        $this->create_var = "Accounting-invoiceType-add";
        $this->edit_var = "Accounting-invoiceType-edit";
        $this->delete_var = "Accounting-invoiceType-delete";
        ...
        [
            ...
            __('messages.transfer_type'),
            __('messages.journal_types'),
            __('messages.numbering_type'),
            __('messages.tax_status'),
            __('messages.default_payment_method'),
            __('messages.sales_account'),
            __('messages.non_tax_account'),
            __('messages.zero_tax_account'),
            __('messages.transport_account'),
            __('messages.defualt_partner'),
            __('messages.branch'),
            __('messages.header'),
            __('messages.footer'),
        ];
        ...
        $this->inputTypes = [
            ...
            'search_select','search_select', 'search_select','search_select', 'search_select2',
            'select_another_table','text_area','text_area'

        ];
        $this->required = [
            'required', 'required',null,null,null,
             'required', 'required', 'required', 'required', 'required', 'required',
            'required', null,null,null,null,'required','required',null,
        ...
        $this->options = [
            ...
            ['1' => 'ضريبي', '2' => 'معفي','3' => 'صفري'],
            ['1' => 'نقدي', '2' => 'ذمم',],
        ];

        $this->routeName = 'invoiceTypes'; // Change to your route name
        $this->modelName = InvoiceType::class; // Change to your model name
