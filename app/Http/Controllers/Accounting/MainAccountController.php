...
class MainAccountController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "Accounting-mainAccount-table";
        $this->create_var = "Accounting-mainAccount-add";
        $this->edit_var = "Accounting-mainAccount-edit";
        $this->delete_var = "Accounting-mainAccount-delete";
        ...
        $this->columns_table_name = ['number', 'name', 'foreign_name','multiple_branch','account_type','branch_id'];
        $this->inputTypes = ['text', 'text','text','options','options','select_another_table'];
        $this->required = ['required', 'required',null,'required', 'required','required'];
        $this->options = [
            ['1' => 'Active', '2' => 'Inactive'],
            ['1' => 'Profit & Loss', '2' => 'Balance Sheet'],
        ];
        $this->routeName = 'mainAccounts'; // Change to your route name
        $this->modelName = MainAccount::class; // Change to your model name
