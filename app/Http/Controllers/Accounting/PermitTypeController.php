...
class PermitTypeController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-permitType-table";
        $this->create_var = "PayRolls-permitType-add";
        $this->edit_var = "PayRolls-permitType-edit";
        $this->delete_var = "PayRolls-permitType-delete";
        ...
        [
            ...
            __('messages.deducted_from_vacation_balance'),
            __('messages.is_paid'),
            __('messages.can_be_less_than_zero'),
        ];
        ...
        $this->inputTypes = ['text', 'text','text','text','options','options','options'];
        $this->required = ['required', 'required',null,'required',null,null];
        $this->options = [
            ['1' => 'Active', '2' => 'Inactive'],
            ['1' => 'Active', '2' => 'Inactive'],
            ['1' => 'Active', '2' => 'Inactive'],
        ...
        $this->routeName = 'permitTypes'; // Change to your route name
        $this->modelName = PermitType::class; // Change to your model name
