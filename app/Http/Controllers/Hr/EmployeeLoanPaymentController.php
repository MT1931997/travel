...
class EmployeeLoanPaymentController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-employeeLoanPayment-table";
        $this->create_var = "PayRolls-employeeLoanPayment-add";
        $this->edit_var = "PayRolls-employeeLoanPayment-edit";
        $this->delete_var = "PayRolls-employeeLoanPayment-delete";

        $this->columnsIndex = ['id','amount', 'date_loan'];
        $this->columns_view =
        [
            __('messages.amount'),
            __('messages.Date'),
        ...
        $this->inputTypes = ['text', 'date','text_area',];
        $this->required = ['required', 'required',null];
        $this->options = ['male','female'];
        $this->routeName = 'employeeLoanPayments'; // Change to your route name
        $this->modelName = EmployeeLoanPayment::class; // Change to your model name
