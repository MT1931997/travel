...
class EmployeeAttendanceController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-employeeAttendance-table";
        $this->create_var = "PayRolls-employeeAttendance-add";
        $this->edit_var = "PayRolls-employeeAttendance-edit";
        $this->delete_var = "PayRolls-employeeAttendance-delete";

        $this->columnsIndex = ['id','employee_id',];
        $this->columns_view =
        [
            __('messages.in_date_time'),
            __('messages.out_date_time'),
            __('messages.leave_start_time'),
            __('messages.leave_back_time'),
            __('messages.Date'),
            __('messages.note'),
        ...
        $this->inputTypes = ['date_time', 'date_time','time','time','date','text_area','search_select'];
        $this->required = ['required', 'required',null,null,'required',null,'required'];
        $this->options = ['male','female'];
        $this->routeName = 'employeeAttendances'; // Change to your route name
        $this->modelName = EmployeeAttendance::class; // Change to your model name
