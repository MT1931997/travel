...
class EmployeeClearanceController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-employeeClearance-table";
        $this->create_var = "PayRolls-employeeClearance-add";
        $this->edit_var = "PayRolls-employeeClearance-edit";
        $this->delete_var = "PayRolls-employeeClearance-delete";
        ...
        $this->columns_table_name = ['date_employee_clearance','employee_id',];
        $this->inputTypes = ['date','search_select',];
        $this->required = ['required', 'required'];
        $this->options = ['male','female'];
        $this->routeName = 'employeeClearances'; // Change to your route name
        $this->modelName = EmployeeClearance::class; // Change to your model name
