...
class ShiftHolidayController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-shiftHoliday-table";
        $this->create_var = "PayRolls-shiftHoliday-add";
        $this->edit_var = "PayRolls-shiftHoliday-edit";
        $this->delete_var = "PayRolls-shiftHoliday-delete";
        ...
        $this->inputTypes = ['date', 'date','date','select_another_table','select_another_table_two'];
        $this->required = ['required', 'required','required','required','required'];
        $this->options = ['male','female'];
        $this->routeName = 'shiftHolidays'; // Change to your route name
        $this->modelName = ShiftHoliday::class; // Change to your model name
        $this->model_name_for_another_table_select = Shift::class; // Change to  model name
        $this->model_name_for_another_table_select2 = Holiday::class; // Change to  model name
