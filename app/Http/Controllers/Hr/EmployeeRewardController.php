...
class EmployeeRewardController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-employeeReward-table";
        $this->create_var = "PayRolls-employeeReward-add";
        $this->edit_var = "PayRolls-employeeReward-edit";
        $this->delete_var = "PayRolls-employeeReward-delete";
        ...
        $this->routeName = 'employeeRewards'; // Change to your route name
        $this->modelName = EmployeeReward::class; // Change to your model name
        $this->model_name_for_another_table_select = Reward::class; // Change to  model name
