...
class EmployeePermitController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-employeePermit-table";
        $this->create_var = "PayRolls-employeePermit-add";
        $this->edit_var = "PayRolls-employeePermit-edit";
        $this->delete_var = "PayRolls-employeePermit-delete";
        ...
        [
            ...
            __('messages.to_date'),
            __('messages.did_not_check_balance_from_total_balance'),
            __('messages.permitTypes'),
        ...
        'from_date',
        'to_date',
        'did_not_check_balance_from_total_balance',
        'permit_type_id',
        'employee_id',
        'note',
    ];
        $this->inputTypes = ['date', 'date','options','select_another_table','search_select','text_area'];
        $this->required = ['required', 'required',null,'required', 'required',null];
        $this->options = [
            ['1' => 'Active', '2' => 'Inactive'],
           ];
        $this->routeName = 'employeePermits'; // Change to your route name
        $this->modelName = EmployeePermit::class; // Change to your model name
        $this->model_name_for_another_table_select = PermitType::class; // Change to  model name
