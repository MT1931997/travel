...
class AllowanceOnSalaryController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-allowanceOnSalary-table";
        $this->create_var = "PayRolls-allowanceOnSalary-add";
        $this->edit_var = "PayRolls-allowanceOnSalary-edit";
        $this->delete_var = "PayRolls-allowanceOnSalary-delete";
        ...
        $this->routeName = 'allowanceOnSalarys'; // Change to your route name
        $this->modelName = AllowanceOnSalary::class; // Change to your model name
