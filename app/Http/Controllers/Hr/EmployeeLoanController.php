...
class EmployeeLoanController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-employeeLoan-table";
        $this->create_var = "PayRolls-employeeLoan-add";
        $this->edit_var = "PayRolls-employeeLoan-edit";
        $this->delete_var = "PayRolls-employeeLoan-delete";
        ...
        [
            ...
            __('messages.Name'),
            __('messages.Date'),
            __('messages.date_monthly_payment'),
            __('messages.monthly_payment'),
        ...
        $this->inputTypes = ['text', 'text','date','date','text','search_select','text_area'];
        $this->required = ['required', 'required','required', 'required','required', 'required',null];
        $this->options = ['male','female'];
        $this->routeName = 'employeeLoans'; // Change to your route name
        $this->modelName = EmployeeLoan::class; // Change to your model name
