...
class PettyCashController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-pettyCash-table";
        $this->create_var = "PayRolls-pettyCash-add";
        $this->edit_var = "PayRolls-pettyCash-edit";
        $this->delete_var = "PayRolls-pettyCash-delete";
        ...
        $this->routeName = 'pettyCashes'; // Change to your route name
        $this->modelName = PettyCash::class; // Change to your model name
