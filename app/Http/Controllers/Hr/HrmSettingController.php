...
class HrmSettingController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-hrmSetting-table";
        $this->create_var = "PayRolls-hrmSetting-add";
        $this->edit_var = "PayRolls-hrmSetting-edit";
        $this->delete_var = "PayRolls-hrmSetting-delete";

        $this->columnsIndex = ['id'];
        $this->columns_view =
        [

            __('messages.income_tax_limit_married'),
            __('messages.income_tax_limit_single'),
            __('messages.calc_salary_with_allowance'),
            __('messages.branch'),
            __('messages.salary_debit_account'),
            __('messages.income_tax_account'),
            __('messages.employee_clearances_header'),
            __('messages.employee_clearances_footer'),
        ];
        ...
        $this->inputTypes = ['text', 'text','options','select_another_table','search_select','search_select','text_area','text_area'];
        $this->required = ['required', 'required','required','required', null,null,null,null];
        $this->options = [
            ['1' => 'Active', '2' => 'Inactive'],
        ];

        $this->routeName = 'hrmSettings'; // Change to your route name
        $this->modelName = HrmSetting::class; // Change to your model name
