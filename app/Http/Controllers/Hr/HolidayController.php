...
class HolidayController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-holiday-table";
        $this->create_var = "PayRolls-holiday-add";
        $this->edit_var = "PayRolls-holiday-edit";
        $this->delete_var = "PayRolls-holiday-delete";
        ...
        $this->routeName = 'holidays'; // Change to your route name
        $this->modelName = Holiday::class; // Change to your model name
