...
class EmployeeDeductionController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-employeeDeduction-table";
        $this->create_var = "PayRolls-employeeDeduction-add";
        $this->edit_var = "PayRolls-employeeDeduction-edit";
        $this->delete_var = "PayRolls-employeeDeduction-delete";
        ...
        $this->routeName = 'employeeDeductions'; // Change to your route name
        $this->modelName = EmployeeDeduction::class; // Change to your model name
        $this->model_name_for_another_table_select = Deduction::class; // Change to  model name
