...
use App\Models\EmployeePettyCash;
use App\Models\PettyCash;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class EmployeePettyCashController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-employeePettyCash-table";
        $this->create_var = "PayRolls-employeePettyCash-add";
        $this->edit_var = "PayRolls-employeePettyCash-edit";
        $this->delete_var = "PayRolls-employeePettyCash-delete";
        ...
        $this->routeName = 'employeePettyCashes'; // Change to your route name
        $this->modelName = EmployeePettyCash::class; // Change to your model name
        $this->model_name_for_another_table_select = PettyCash::class; // Change to  model name
