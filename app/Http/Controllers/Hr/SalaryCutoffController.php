...
class SalaryCutoffController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-salaryCutoff-table";
        $this->create_var = "PayRolls-salaryCutoff-add";
        $this->edit_var = "PayRolls-salaryCutoff-edit";
        $this->delete_var = "PayRolls-salaryCutoff-delete";
        ...
        $this->routeName = 'salaryCutoffs'; // Change to your route name
        $this->modelName = SalaryCutoff::class; // Change to your model name
