...
class RewardController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-reward-table";
        $this->create_var = "PayRolls-reward-add";
        $this->edit_var = "PayRolls-reward-edit";
        $this->delete_var = "PayRolls-reward-delete";
        ...
        [
            ...
            __('messages.amount'),
            __('messages.percentage_from_main_salary'),
        ];
        $this->columns_table_name = ['number', 'name', 'foreign_name','amount','percentage_from_main_salary'];
        $this->inputTypes = ['text', 'text','text','text','text',];
        $this->required = ['required', 'required',null,'required',null];
        $this->options = ['male','female'];
        $this->routeName = 'rewards'; // Change to your route name
        $this->modelName = Reward::class; // Change to your model name
