...
use App\Models\EmployeeCutoff;
use App\Models\SalaryCutoff;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class EmployeeCutoffController extends Controller
{
   protected $columnsIndex;
    ...
    {
        $this->index_var = "PayRolls-employeeCutoff-table";
        $this->create_var = "PayRolls-employeeCutoff-add";
        $this->edit_var = "PayRolls-employeeCutoff-edit";
        $this->delete_var = "PayRolls-employeeCutoff-delete";
        ...
        $this->routeName = 'employeeCutoffs'; // Change to your route name
        $this->modelName = EmployeeCutoff::class; // Change to your model name
        $this->model_name_for_another_table_select = SalaryCutoff::class; // Change to  model name
